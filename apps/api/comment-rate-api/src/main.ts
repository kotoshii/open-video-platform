...
import { COMMENT_RATES_PACKAGE_NAME } from "@ovp-proto/types/comment-rates";
...
async function bootstrap() {
	...
	const app = configBuilder
		.addDefaults()
		.addSwagger("Comment Rate API Specification")
		.addMicroservice({
			transport: Transport.GRPC,
			options: {
				package: COMMENT_RATES_PACKAGE_NAME,
				url: grpcConfig.grpcUrl,
				protoPath: ProtoPaths.CommentRates,
