...
import { KAFKA_DEDUP_CONFIG_INJECTION_TOKEN } from "@ovp-lib/api/config/constants/injection-tokens";
...
@Module({
	...
	exports: [AppConfig, DatabaseConfig, KafkaConfig, KAFKA_DEDUP_CONFIG_INJECTION_TOKEN],
})
