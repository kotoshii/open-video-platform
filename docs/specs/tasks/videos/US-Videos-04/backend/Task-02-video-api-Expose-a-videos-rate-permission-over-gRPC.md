...
rates and comments. Return the video's title and its channel id with the answer: `video-rate-api` and `comment-api`
store the title next to their rows, so the rated videos and My comments pages can search by it
