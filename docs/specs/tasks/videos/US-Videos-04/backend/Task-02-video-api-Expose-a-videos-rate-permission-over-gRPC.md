...
rates. Return the video's title with the answer: `video-rate-api` and `comment-api` store it next to their rows, so
the rated videos and My comments pages can search by it
([US-My-activity-02](../../../../user-stories/my-activity/US-My-activity-02-Rated-videos.md),
[US-My-activity-03](../../../../user-stories/my-activity/US-My-activity-03-My-comments.md)).
