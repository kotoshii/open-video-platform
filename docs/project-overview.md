...
* [Account creation and authentication](user-stories/auth/US-Auth-1-Account-creation-and-login.md) (via email and
  password)
* [Account confirmation](user-stories/auth/US-Auth-2-Account-confirmation.md) (via email)
* [Ability to reset password](user-stories/auth/US-Auth-3-Password-reset.md) (via email)
* [Session persistence](user-stories/auth/US-Auth-4-Session-persistence.md) (JWT rotation/refresh)
* [Session management](user-stories/auth/US-Auth-5-Session-management.md)
* [Ability to log out](user-stories/auth/US-Auth-6-Logging-out.md)
